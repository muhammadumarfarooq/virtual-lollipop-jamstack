...
const Lolly = ({ lollyBottomColor, lollyTopColor, lollyMiddleColor }) => {
  return (
    <div className="lolly">
        ...
        <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Lolly">
            <g id="handle" transform="translate(65.000000, 137.000000)" fillRule="nonzero">
              ...
              <polygon id="Rectangle-Copy-3" fillOpacity="0.181584013" fill="#8C0040"
                       points="0 200 32 200 32 218 0 223.801515" />
            </g>
            <mask id="mask-2" fill="white">
              <use href="#path-1" />
            </mask>
            <use className="lollyBottom" fill={lollyBottomColor} fillRule="nonzero" href="#path-1" />
            <rect className="lollyTop" fill={lollyTopColor} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9"
                  width="224" height="134" />
            <rect className="lollyMiddle" fill={lollyMiddleColor} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113"
            ...
            <path
              ...
              id="shade" fill="#67000D" fillRule="nonzero" opacity="0.0961449033" mask="url(#mask-2)" />
            <mask id="mask-4" fill="white">
              <use href="#path-3" />
            </mask>
            <use id="shine" fill="#FFFFFF" fillRule="nonzero" opacity="0.113420759" href="#path-3" />
            <g id="glint" opacity="0.600144159"
            ...
            <path
              ...
              id="frozenhandle" fill="#A7563C" fillRule="nonzero" opacity="0.0615234375" />
          </g>
        </g>
      </svg>
    </div>
